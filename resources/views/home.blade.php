                        ...
                        <div class="categories-menu mrg-xs">
                            ...
                            <div class="category-menu-list">
                                <ul>
                                    ...
                                    <li>
                                        <a href="#"><img alt="" src="">{{$cate->name}}</i></a>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
                                                ...
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="product-details.html">
                                                                <img src="{{url('public/uploads')}}/{{$product->image}}" alt="product images">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="product__details">
                                                        ...
                                                        <ul class="product__price">
                                                            ...
                                                            <li class="new__price">{{$product->sell_price}}</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
